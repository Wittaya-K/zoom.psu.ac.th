...
@section('content')
    <h3 class="page-title">@lang('quickadmin.zooms.title')</h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <div class="row">
                <div class="col-md-6">
                    <table class="table table-bordered table-striped">
                        <tr>
                            <th>@lang('quickadmin.zooms.fields.zoom-number')</th>
                            <td field-key='zoom_number'>{{ $zoom->zoom_number }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.zooms.fields.floor')</th>
                            <td field-key='floor'>{{ $zoom->password }}</td>
                        </tr>
                        <tr>
                            <th>@lang('quickadmin.zooms.fields.description')</th>
                ...
                <div role="tabpanel" class="tab-pane active" id="bookings">
                    <table class="table table-bordered table-striped {{ count($bookings) > 0 ? 'datatable' : '' }}">
                        ...
                        <tr>
                            ...
                            <th>@lang('quickadmin.bookings.fields.zoom')</th>
                        ...
                        @if (count($bookings) > 0)
                            @foreach ($bookings as $booking)
                                <tr data-entry-id="{{ $booking->id }}">
                                    ...
                                    <td field-key='zoom'>{{ $booking->zoom->zoom_number or '' }}</td>
            ...
            <a href="{{ route('admin.zooms.index') }}" class="btn btn-default">@lang('quickadmin.qa_back_to_list')</a>
        </div>
    </div>
@stop
