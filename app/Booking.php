...
class Booking extends Model
{
    ...
    protected $fillable = ['time_from', 'time_to', 'additional_information', 'customer_id', 'zoom_id','user_name','status_approve','zoom_number','zoom_email'];
     ...
     * @param $input
     */
    public function setZoomIdAttribute($input)
    {
        $this->attributes['zoom_id'] = $input ? $input : null;
    }
    ...
    {
        return $this->belongsTo(Zoom::class, 'Zoom_id')->withTrashed();
    }
}
