...
Route::group(['middleware' => ['auth'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('zooms', 'Admin\ZoomsController');
    Route::post('Zooms_mass_destroy', ['uses' => 'Admin\ZoomsController@massDestroy', 'as' => 'zooms.mass_destroy']);
    Route::post('Zooms_restore/{id}', ['uses' => 'Admin\ZoomsController@restore', 'as' => 'zooms.restore']);
    Route::delete('Zooms_perma_del/{id}', ['uses' => 'Admin\ZoomsController@perma_del', 'as' => 'zooms.perma_del']);
    ...
    Route::get('booklists', 'Admin\BooklistsController@index')->name('booklists.index ');
